...
var taskInput=document.querySelector(".input");//Add a new task.
...
var taskCompleted=function(){
    ...
    // this.parentNode.classList.add('completed__item');
    // this.parentNode.classList.remove('todo__item');
    var listItem=this.parentNode;
...
//Mark task as incomplete.
    ...
    // this.parentNode.classList.add('todo__item');
    // this.parentNode.classList.remove('completed__item');
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
